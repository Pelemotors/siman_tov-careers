...
const staticPrograms = [
  {
    id: 1,
    name_he: 'חבילת ייעוץ בסיסית',
    description_he: 'חבילה מקיפה לייעוץ קריירה בסיסי עם כתיבת קורות חיים והכנה לראיון.',
    features_he: [
      'כתיבת קורות חיים',
      'הכנה לראיון אחד',
      'ייעוץ קריירה בסיסי',
  ...
  {
    id: 2,
    name_he: 'חבילת ייעוץ מתקדמת',
    description_he: 'חבילה מקיפה לייעוץ קריירה מתקדם עם כל השירותים והתמיכה המלאה.',
    features_he: [
      'כתיבת קורות חיים',
      'בניית פרופיל לינקדאין',
      'הכנה לראיונות מרובים',
      'ייעוץ קריירה מקיף',
      'תמיכה 24/7',
    ],
  },

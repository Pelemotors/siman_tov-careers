      ...
      <div className="text-center mb-12 md:mb-16">
        ...
        <div className="max-w-3xl mx-auto text-right space-y-4 mb-8">
          <p className="text-base text-text-dark font-body">
            ...
            <br />
            מספיק לזהות מה <em>לא ברור</em> (או מה נשמע גנרי) בקורות החיים או בפרופיל הלינקדאין שלך ולתקן את הדבר הראשון שמפיל פניות ממגייסים.
          </p>
          <p className="text-base text-text-dark font-body">
            בבדיקה הזו אני בודקת:
          </p>
          <ul className="text-base text-text-dark font-body list-disc list-inside space-y-2 mr-4">
            <li>האם המסר בקורות החיים/פרופיל הלינקדאין ברור תוך כמה שניות</li>
            <li>האם הצעת הערך שלך חד־משמעית ומדגישה את החוזקות</li>
            <li>האם יש קריאה לפעולה ברורה שמובילה לפנייה ממגייסים</li>
            <li>האם יש מילות מפתח רלוונטיות שיעזרו לך לעבור את מערכות ה-ATS</li>
          </ul>
        </div>
      </div>

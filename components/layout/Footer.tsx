        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/90 text-base font-body font-medium">
              10+ שנים בגיוס ומשאבי אנוש. סיוע בחיפוש עבודה, כתיבת קורות חיים והכנה לראיונות.
            </p>
          </div>
          ...
          {/* Social Media */}
          <div>
            <h4 className="font-heading font-semibold mb-4">חפשו אותי גם ברשתות החברתיות</h4>
            <div className="flex flex-col gap-3">
              <a
                href={SOCIAL_LINKS.linkedin}
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/90 hover:text-white transition-colors font-body font-medium flex items-center gap-2"
              >

...
export const StickyWhatsAppButton: React.FC = () => {
  const defaultMessage = process.env.NEXT_PUBLIC_WHATSAPP_MESSAGE || 'שלום, אני מעוניין במידע על ייעוץ קריירה';
  
  const whatsappUrl = `${SOCIAL_LINKS.whatsapp}&text=${encodeURIComponent(defaultMessage)}`;

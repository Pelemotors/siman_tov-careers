        ...
        <body>
          ...
          <div class="content">
            ...
            <div class="field">
              ...
              <div class="field-value">${escapeHtml(data.source === 'contact_form' ? 'טופס יצירת קשר' : 'שאלון הערכת קריירה')}</div>
            </div>
            ` : ''}
...
הודעה: ${data.message}
${data.source ? `מקור: ${data.source === 'contact_form' ? 'טופס יצירת קשר' : 'שאלון הערכת קריירה'}` : ''}

      ...
      <Card className="mb-6">
        <div className="flex flex-wrap gap-4">
          <select className="px-4 py-2 rounded-lg border-2 border-accent-sky bg-white">
            ...
            <option value="career-advice">ייעוץ קריירה</option>
            <option value="cv-writing">כתיבת קורות חיים</option>
            <option value="linkedin">בניית פרופיל לינקדאין</option>
            <option value="interview-prep">הכנה לראיונות</option>
          </select>
          <select className="px-4 py-2 rounded-lg border-2 border-accent-sky bg-white">
